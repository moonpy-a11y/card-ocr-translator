#!/bin/bash
# =========================================================
# script2.sh: True Progressive Commit Generator
# =========================================================

echo "🚀 Resetting workspace for incremental Git history..."
cd ~/Card-OCR-Translator

# ---------------------------------------------------------
# STAGE 1: Add Performance Tracker Feature
# ---------------------------------------------------------
echo "📝 [Stage 1/3] Adding Latency Optimization Layer..."
cat << 'EOF' > app.py
import io
import os
import re
